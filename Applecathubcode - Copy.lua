...
local v3 = {
    [1] = "chuẩn bị update chức năng đánh levi",
    [2] = "update trial tộc draco",
    [3] = "pvp thì sài script này bay ra thôi chưa cs aimbot",
    [4] = "sắp cập nhật aimbot giống redzhub"
};
...
local v15 = v14:CreateWindow({
    Title = "Apple Cat Hub-Blox Fruit [Premium]",
